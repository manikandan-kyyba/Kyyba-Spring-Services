...
public class AppUtil {
	...
	private static final String SWAGGER_API_PONIT_END_VERSION = "/api/v1";
	...
	public static final String SWAGGER_API_END_POINT_USER_LOGIN = SWAGGER_API_PONIT_END_VERSION + "/user_login";
	public static final String SWAGGER_API_END_POINT_USER_LOGOUT = SWAGGER_API_PONIT_END_VERSION + "/user_logout";
}
